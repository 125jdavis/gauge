...
// NeoPixel strip for LED tachometer (PC6, 64 LEDs max, GRB color order, 800 KHz)
// Performance: ~2.18 ms per update for 64 LEDs (~8% slower than FastLED but negligible for tachometer)
